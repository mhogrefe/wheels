...
public class RandomProviderTest {
    ...
    public void testPositiveBigIntegers() {
        aeq(take(20, P.positiveBigIntegers()),
                ...
                " 7532600913987301393787776023776380057180403400673862364081, 1, 90623852880020253, 520713022518431," +
                " 2440457, 21776818515, 1980643, 2193505253511091, 900745, 15115, 32517]");
    }
