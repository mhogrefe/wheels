...
public class RandomProviderTest {
    ...
    public void testNaturalBytes() {
        aeq(take(20, P.naturalBytes()),
                "[104, 127, 84, 92, 1, 83, 75, 45, 108, 35," +
                " 35, 43, 10, 67, 99, 110, 78, 9, 123, 61]");
    }

    @Test
    public void testNaturalShorts() {
        aeq(take(20, P.naturalShorts()),
                "[26694, 32709, 21547, 23767, 416, 21441, 19263, 11624, 27826, 9073," +
                " 8997, 11244, 2561, 17158, 25536, 28321, 20207, 2535, 31686, 15830]");
    }

    @Test
    public void testNaturalIntegers() {
        aeq(take(20, P.naturalIntegers()),
                "[54555073, 1523693452, 1189267451, 1179298315, 1473891449, 335757816, 332315457, 2074906518," +
                " 109678714, 1950678019, 897372298, 1291858686, 634156052, 1162954381, 1341354230, 1996451925," +
                " 1327922237, 562835242, 215944278, 1802238522]");
    }

    @Test
    public void testNaturalLongs() {
        aeq(take(20, P.naturalLongs()),
                "[234312252881255396, 5065047696626797689, 1442068837050396699, 471066488414342743," +
                " 8378098296417551167, 3854184673538224894, 2723679502578984382, 5761072552197714005," +
                " 2417358956864889798, 927473613570570810, 4540999732700189122, 3399189097489761483," +
                " 1583678936457625315, 6836099128698250938, 54637036172944599, 4994466079092908716," +
                " 7701145665027149924, 7103937164746600754, 3451606167858841597, 6162646448824365988]");
    }
