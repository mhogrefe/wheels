...
public class RandomProviderTest {
    ...
    public void testNaturalBytes() {
        aeq(take(20, P.naturalBytes()),
                "[104, 127, 84, 92, 1, 83, 75, 45, 108, 35, 35, 43, 10, 67, 99, 110, 78, 9, 123, 61]");
    }
    ...
    public void testBytes() {
        aeq(take(20, P.bytes()),
                "[80, 127, 40, 57, -125, 39, 22, -38, 89, -58, -58, -41, -108, 6, 71, 93, 29, -109, 119, -5]");
    }

    @Test
    public void testShorts() {
        aeq(take(20, P.shorts()),
                "[20621, 32651, 10327, 14767, -31936, 10114, 5758, -9519, 22884, -14622," +
                " -14774, -10279, -27645, 1548, 18305, 23875, 7647, -27698, 30604, -1108]");
    }
